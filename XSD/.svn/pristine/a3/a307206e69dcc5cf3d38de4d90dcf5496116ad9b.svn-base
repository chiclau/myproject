...
@Entity
@Table(name="hjb_hps_info")
public class HjbInfoBean implements Serializable{
    ...
    @Column(name = "tbsj") private String tbsj;
    ...
    @Column(name = "hpsjzytcsj") private String hpsjzytcsj;

    @Column(name = "sfyjgbg") private String sfyjgbg;

    @Column(name = "dztcsjybhqslsjxhgx") private String dztcsjybhqslsjxhgx;

    @Column(name = "sd_sheng") private String sdSheng;

    @Column(name = "sd_shi") private String sdShi;

    @Column(name = "sd_xian") private String sdXian;

    @Column(name = "sd_shengId") private Integer sdShengId;

    @Column(name = "sd_shiId") private Integer sdShiId;

    @Column(name = "sd_xianId") private Integer sdXianId;
    ...
    public void setHpsjzytcsj(String hpsjzytcsj) {
        this.hpsjzytcsj = hpsjzytcsj == null ? null : hpsjzytcsj.trim();
    }
    ...
    public void setSfyjgbg(String sfyjgbg) {
        this.sfyjgbg = sfyjgbg == null ? null : sfyjgbg.trim();
    }
    ...
    public void setDztcsjybhqslsjxhgx(String dztcsjybhqslsjxhgx) {
        this.dztcsjybhqslsjxhgx = dztcsjybhqslsjxhgx == null ? null : dztcsjybhqslsjxhgx.trim();
    }
    ...
    public void setSdSheng(String sdSheng) {
        this.sdSheng = sdSheng == null ? null : sdSheng.trim();
    }
    ...
    public void setSdShi(String sdShi) {
        this.sdShi = sdShi == null ? null : sdShi.trim();
    }

    public String getSdXian() {
        return sdXian;
    }

    public void setSdXian(String sdXian) {
        this.sdXian = sdXian == null ? null : sdXian.trim();
    }

    public Integer getSdShengId() {
        return sdShengId;
    }

    public void setSdShengId(Integer sdShengId) {
        this.sdShengId = sdShengId;
    }

    public Integer getSdShiId() {
        return sdShiId;
    }

    public void setSdShiId(Integer sdShiId) {
        this.sdShiId = sdShiId;
    }

    public Integer getSdXianId() {
        return sdXianId;
    }

    public void setSdXianId(Integer sdXianId) {
        this.sdXianId = sdXianId;
    }
}