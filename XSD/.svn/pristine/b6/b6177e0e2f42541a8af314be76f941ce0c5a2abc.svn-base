	   ...
	   <div	class="row">
			<div class="col-md-12" style="padding-right:0px;">
				...
				<div class="col-md-2" style="padding-bottom:5px;padding-right:0px;">
					...
					<div class="col-md-2" style="padding-right:0px">
						<div class="input-group ">
							<input type="text" id="searchName_zcfg" class="form-control"
								placeholder="关键字(法规内容/来源/分类/发布单位)" style="width: 300px;"> <span class="input-group-btn">
					...
					<!-- 	<div class="col-md-2" style="padding-right:0px">
						<div class="input-group"  style=" margin-left: 173px;"> 
		...
		<div style="height:calc(100% - 140px);">
			<div id="tbinfo_user_div" style="height:calc(100% - 2px);">
			 <table class="layui-hide" id="testone" lay-filter="test" style="width: 100%"> </table>
			  <script type="text/html" id="id">
 				{{d.LAY_TABLE_INDEX+1}}
				</script>
			 <script type="text/html" id="barDemo">
  				 <a target='_Blank' class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">预览</a>
			</script>
		</div>
	</div>
	</div>
