	 ...
	 <div class="container-fluid">
          <div class="row">
              <div class="col-md-6" style="margin-top:2px;">
                 <ul class="list-group list-group-one">
					  <li class="list-group-item" id="item-one">
					   		<i class="icon icon-area-chart" style="margin-right:10px"></i><span id= "title_id_js"></span>
					  </li>
              ...
              <div class="col-md-6" style="margin-top:-8px;">
                   <ul class="list-group list-group-one">
					  <li class="list-group-item" id="item-one">
					   		<i class="icon icon-area-chart" style="margin-right:10px"></i><span id= "title_id_kffs"></span>
					  </li>
              ...
              <div class="col-md-6">
                  <ul class="list-group list-group-one">
					  <li class="list-group-item" id="item-one">
					   		<i class="icon icon-area-chart" style="margin-right:10px"></i><span id= "title_id_ljtc"></span>
					  </li>
              ...
              <div class="col-md-6">
                 <ul class="list-group list-group-one">
					  <li class="list-group-item" id="item-one">
					   		<i class="icon icon-area-chart" style="margin-right:10px"></i><span id= "title_id_zjrl1"></span>
					  </li>
...
function initKffs(bj,address){
    ...
    var value = 0;
    if(bj == "1"){
		$("#title_id_kffs").text("（"+address+"）"+"小水电开发方式统计图");
		var text = "（"+address+"）"+"小水电开发方式统计图"
 	}
     $.ajax({
...
function initJszt(bj,address){
	 ...
	 if(bj == "1"){
			$("#title_id_js").text("（"+address+"）"+"小水电建设状态统计图");
			var text = "（"+address+"）"+"小水电建设状态统计图"
	 }
     var leng = [];
     var jszt = [];
     var datas = [];
 		...
 		success:function(response){
			...
			myChart.on('click', function (params) {
				layer.open({
					  ...
					  icon: 6,
					  content: '<%=basePath%>business/cezhanchaxun/modalFrame.jsp',
...
function initZjrl(bj,address){
    ...
    if(bj == "1"){
		$("#title_id_zjrl1").text("（"+address+"）"+"各年小水电投产累计装机容量统计图");
		var text = "（"+address+"）"+"各年小水电投产累计装机容量统计图"
 	}
    var sum = [];
    var sum1 = [];
    var yer = [];
...
function initDzsl(bj,address){
    ...
    if(bj == "1"){
		$("#title_id_ljtc").text("（"+address+"）"+"各年小水电投产累计数量统计图");
		var text = "（"+address+"）"+"各年小水电投产累计数量统计图"
 	}
    var sum3 = [];
    var sum4 = [];
    var yer4 = [];
