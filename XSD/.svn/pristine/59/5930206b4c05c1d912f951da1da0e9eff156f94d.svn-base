...
function _AutoSize(){
	// 设置Table的高度
	$("#tbinfo_role").bootstrapTable("resetView",{"height":$("#tbinfo_role_div").height()}); 
} 
...
/*//保存
function btnSave(){
		var json=$("#info_form_role").serialize();
		var url_save=basePath+"system/sysrole!save.action"	;
		$("#info_dialog_role").modal("hide");
