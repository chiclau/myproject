		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12"
					...
					<!--  <table class="layui-table" id="searchList" style="border-radius:6px;">
			  <colgroup>
			    <col width="80">
			    <col width="100">
			    <col width="">
			  ...
			  <thead>
			    <tr>
				     ...
				     <th>项目位置</th>
				     <th>所在河流（对应具体河流）</th>
				     <th style="text-align: left;">装机容量</th>
				     <th>总投资</th>
				     <th>设计年发电量</th>
				     <th>建设（运营）状态</th>
				     <th>投资性质/来源</th>
			...
			<ul class="pager" style="float:right;padding-top:15px;padding-bottom:15px;" id="pageNum_id">		
			</ul> -->
				</div>
			</div>
		</div>
     ...
     $.ajax({
		...
		success:function(response){
			...
			for (var i = 0; i < data.length; i++) {
				...
				var object={'name':data[i].name,'value':v .toFixed(2)}
				obj.push(object);
			}
