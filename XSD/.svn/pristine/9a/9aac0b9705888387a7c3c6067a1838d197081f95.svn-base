...
<body>
	<div style="height: 300px; width: 100%;">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6"
					style="margin-top: 8x; padding-left: 0px; height: 590px;" id ="one">
				...
				<div class="col-md-6"
					style="margin-top: 8x; padding-left: 0px; height: 590px;"id ="two">
					<ul class="list-group list-group-one">
						<li class="list-group-item" id="item-one"><i
							class="icon icon-area-chart" style="margin-right: 10px"></i><span
							id="dzrl_id"></span></li>
				...
				<button class="btn btn-primary"
					...
					type="button" onclick = "exprot()">导出</button>
				<div class="col-md-12"
...
exprot = function(){
	debugger;
	 ...
	 if(bj == 0 || bj ==1){
		 if(name == "总数"){
			 sql = " SELECT a.id as id, a.xmmc as xmmc,a.xmwz AS xmwz,a.jthl as jthl,a.zjrl as zjrl,a.ztz as ztz,a.sjnfdl as sjnfdl,b.name AS jszt,a.tzxz as tzxz,ss.name as bwqk,c.name AS kffs,a.sfyxmhz as sfyxmhz  "
			     + " FROM hps_info_sum1 a LEFT JOIN sys_dict b ON a.jszt = b.nm AND b.listnm_sys_dict_cate = 'jszt' "
			     + "  LEFT JOIN sys_dict c ON a.kffs = c.nm AND c.listnm_sys_dict_cate = 'kffs'  "
			     + " LEFT JOIN sys_dict ss ON a.bwqk = ss.nm AND ss.listnm_sys_dict_cate = 'bwqk'  "
			     +"    ORDER BY sheng  "
		 }else{
			 sql = " SELECT a.id as id, a.xmmc as xmmc,a.xmwz AS xmwz,a.jthl as jthl,a.zjrl as zjrl,a.ztz as ztz,a.sjnfdl as sjnfdl,b.name AS jszt,a.tzxz as tzxz,ss.name as bwqk,c.name AS kffs,a.sfyxmhz as sfyxmhz "
			     + " FROM hps_info_sum1 a LEFT JOIN sys_dict b ON a.jszt = b.nm AND b.listnm_sys_dict_cate = 'jszt'  "
			     ...
			     + " LEFT JOIN sys_dict ss ON a.bwqk = ss.nm AND ss.listnm_sys_dict_cate = 'bwqk' "
			     + " WHERE 1=1 "
			     +"  AND b.name = '"+name+"'  ORDER BY sheng  "
		 }
	 }
	 if(bj == 2 || bj == 3){
		 if(name == "总数"){
			 sql = " SELECT a.id as id, a.xmmc as xmmc,a.xmwz AS xmwz,a.jthl as jthl,a.zjrl as zjrl,a.ztz as ztz,a.sjnfdl as sjnfdl,b.name AS jszt,a.tzxz as tzxz,ss.name as bwqk,c.name AS kffs,a.sfyxmhz as sfyxmhz "
			     ...
			     + "   LEFT JOIN sys_dict c ON a.kffs = c.nm AND c.listnm_sys_dict_cate = 'kffs'  "
			     + " LEFT JOIN sys_dict ss ON a.bwqk = ss.nm AND ss.listnm_sys_dict_cate = 'bwqk' "
			     + " WHERE  a.sheng IN   ('上海市','安徽省','浙江省','江苏省','湖北省','云南省','贵州省','四川省','重庆市','湖南省','江西省')  "
			     +"    ORDER BY sheng  "
		 }else{
			 sql = " SELECT a.id as id, a.xmmc as xmmc,a.xmwz AS xmwz,a.jthl as jthl,a.zjrl as zjrl,a.ztz as ztz,a.sjnfdl as sjnfdl,b.name AS jszt,a.tzxz as tzxz,ss.name as bwqk,c.name AS kffs,a.sfyxmhz as sfyxmhz "
			     + " FROM hps_info_sum1 a LEFT JOIN sys_dict b ON a.jszt = b.nm AND b.listnm_sys_dict_cate = 'jszt'  "
	 ...
	 if(bj == 4){
		 if(name == "总数"){
			 ...
			 sql = " SELECT h.sheng,h.shi,h.xian,h.xmmc,h.xmwz,ssss.name AS xmszly,h.zjrl,h.tcny,h.ztz,h.sjnfdl,h.bg,h.zrk,s.name AS jszt,h.tzly, "
				 ...
				 + " LEFT JOIN sys_dict sss ON h.kffs = sss.nm AND sss.listnm_sys_dict_cate = 'kffs' "
				 + " LEFT JOIN sys_dict ssss ON h.xmszly = ssss.nm AND sss.listnm_sys_dict_cate = 'xmszly' "
				 + " WHERE sss.name = '"+name+"' AND h.sheng = '"+address+"' " 
		 }
	 }
	 if(bj == 5){
		 if(name == "总数"){
			 ...
			 sql =" SELECT h.sheng,h.shi,h.xian,h.xmmc,h.xmwz,ssss.name AS xmszly,h.zjrl,h.tcny,h.ztz,h.sjnfdl,h.bg,h.zrk,s.name AS jszt,h.tzly, "
				 ...
				 + " LEFT JOIN sys_dict sss ON h.kffs = sss.nm AND sss.listnm_sys_dict_cate = 'kffs' "
				 + " LEFT JOIN sys_dict ssss ON h.xmszly = ssss.nm AND sss.listnm_sys_dict_cate = 'xmszly' "
				 + " WHERE s.name = '"+name+"' AND h.sheng = '"+address+"' " 
		 }
	 }
	 if(bj == 7){
		 if(name == "总数"){
			 ...
			 sql =" SELECT h.sheng,h.shi,h.xian,h.xmmc,h.xmwz,ssss.name AS xmszly,h.zjrl,h.tcny,h.ztz,h.sjnfdl,h.bg,h.zrk,s.name AS jszt,h.tzly, "
				 ...
				 + " LEFT JOIN sys_dict sss ON h.kffs = sss.nm AND sss.listnm_sys_dict_cate = 'kffs' "
				 + " LEFT JOIN sys_dict ssss ON h.xmszly = ssss.nm AND sss.listnm_sys_dict_cate = 'xmszly' "
				 + " WHERE sss.name = '"+name+"' AND h.shi = '"+address+"' " 
		 }
	 }
	 if(bj == 8){
		 if(name == "总数"){
			 ...
			 sql =" SELECT h.sheng,h.shi,h.xian,h.xmmc,h.xmwz,ssss.name AS xmszly,h.zjrl,h.tcny,h.ztz,h.sjnfdl,h.bg,h.zrk,s.name AS jszt,h.tzly, "
				 ...
				 + " LEFT JOIN sys_dict sss ON h.kffs = sss.nm AND sss.listnm_sys_dict_cate = 'kffs' "
				 + " LEFT JOIN sys_dict ssss ON h.xmszly = ssss.nm AND sss.listnm_sys_dict_cate = 'xmszly' "
				 + " WHERE s.name = '"+name+"' AND h.shi = '"+address+"' " 
		 }
	 }
	 if(bj == 10){
		 if(name == "总数"){
...
function daochu(fileName,tabTitle,sqlTitle,sql){
	 $.ajax({
	     ...
	     data : {"uploadBean.tabTitle":tabTitle
	    		...
	    		,"uploadBean.tabType":"2"//直接一行一行的导出
	    	 	},
...
function initTable(name,bj,address){
  ...
  layui.use('table', function(){
   	  ...
   	  table.render({
   	    ...
   	    ,toolbar: '#toolbarDemo'
   	    ,title: '用户数据表'
   	    ,where:{"name":name,"bj":bj,"address":address,"shi":shi}
   	    ,cols: [[
     ...
     $.ajax({
		...
		success:function(response){
			...
			for (var i = 0; i < data.length; i++) {
				...
				var maps = {'name':data[i].name,'value':val}
				rest.push(maps)
				value+=data[i].value;
			}
