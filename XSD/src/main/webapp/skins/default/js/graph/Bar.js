...
SuperMap.Feature.Theme.Bar = SuperMap.Class(SuperMap.Feature.Theme.Graph, {
    ...
    assembleShapes: function () {
        //默认渐变颜色数组
        var deafaultColors = [["rgba(255,255,255,0)", "rgba(255,255,255,0)"], ["#00CCFF", "#5E87A2"], ["#00FF66", "#669985"], ["#CCFF00", "#94A25E"], ["#FF9900", "#A2945E"]];
        // var deafaultColors = [["#FFFFFF","#FFFFFF"]];
        // var deafaultColors = [["rgba(255,255,0,1)","rgba(255,255,0,1)"]];
...
//开始
        var title;
        title = new SuperMap.Feature.ShapeParameters.Label(dvb[0], dvb[3] + 56, this.data.data.ENNM);       // + this.data.data.REALDATA              //制定文本模型  SuperMap.Feature.ShapeParameters.Label(x,y,text)  x为横坐标 y为纵坐标 text为需显示的文本
...
//开始
//         var img;
//         if(this.data.data.REALDATA < 10000){
//             img=new SuperMap.Feature.ShapeParameters.Image(dvb[0]-5,dvb[3]+54,"./images/水电站48.png",56,16);                     //制定文本模型  SuperMap.Feature.ShapeParameters.Label(x,y,text)  x为横坐标 y为纵坐标 text为需显示的文本
//             //dvd为统计图表模型的数据视图框，长度为 4 的一维数组，像素坐标，[left, bottom, right, top]
//         }
//         else{
//             img=new SuperMap.Feature.ShapeParameters.Image(dvb[0]-1,dvb[3]+42,"./images/水电站48.png",56,16);                     //制定文本模型  SuperMap.Feature.ShapeParameters.Label(x,y,text)  x为横坐标 y为纵坐标 text为需显示的文本
//             //dvd为统计图表模型的数据视图框，长度为 4 的一维数组，像素坐标，[left, bottom, right, top]
//         }
//         this.shapes.push(this.shapeFactory.createShape(img));
        var img;
        if(this.data.data.IMG_FLAG=='dz'){
        	if(this.data.data.BLDSTT=='1'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/dz1.png"); 
        	}else if(this.data.data.BLDSTT=='2'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/dz2.png");
        	}else if(this.data.data.BLDSTT=='4'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/dz3.png");
        	}else{
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/dz.png");
        	}
                                //制定文本模型  SuperMap.Feature.ShapeParameters.Label(x,y,text)  x为横坐标 y为纵坐标 text为需显示的文本
        }else if(this.data.data.IMG_FLAG=='sk'){
        	if(this.data.data.BLDSTT=='1'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/sk1.png"); 
        	}else if(this.data.data.BLDSTT=='2'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/sk2.png");
        	}else if(this.data.data.BLDSTT=='4'){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/sk3.png");
        	}else{
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/sk.png");
        	}
        }else if(this.data.data.IMG_FLAG=='stll_dz'){
        	if(this.data.data.SFDB==1||this.data.data.SFDB=="1"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/SDZ_Y.png"); 
        	}else if(this.data.data.SFDB==0||this.data.data.SFDB=="0"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/SDZ_N.png");
        	}else{
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/dz.png");
        	}
        }else if(this.data.data.IMG_FLAG=='stll_sk'){
        	if(this.data.data.SFDB==1||this.data.data.SFDB=="1"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/SK_Y.png"); 
        	}else if(this.data.data.SFDB==0||this.data.data.SFDB=="0"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/SK_N.png");
        	}else{
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/sdz/sk.png");
        	}
        }else if(this.data.data.IMG_FLAG=='dc'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw_y.png");
        }else if(this.data.data.IMG_FLAG=='fc'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='sz'){
        	if(this.data.data.SFDB==1||this.data.data.SFDB=="1"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw_y.png");
        	}else if(this.data.data.SFDB==0||this.data.data.SFDB=="0"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw_n.png");
        	}else{
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        	}
        }else if(this.data.data.IMG_FLAG=='ssst'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='stll'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='yd'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/A.png");
        }else if(this.data.data.IMG_FLAG=='fzr'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/B.png");
        }else if(this.data.data.IMG_FLAG=='jyy'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/C.png");
        }else if(this.data.data.IMG_FLAG=='syj'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/D.png");
        }else if(this.data.data.IMG_FLAG=='ylzzz'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='ylqxd'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='dwsjhss'){
        	if(this.data.data.DWTP==1||this.data.data.DWTP=="1"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/A.png"); 
        	}else if(this.data.data.DWTP==2||this.data.data.DWTP=="2"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/B.png");
        	}else if(this.data.data.DWTP==3||this.data.data.DWTP=="3"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/C.png");
        	}else if(this.data.data.DWTP==4||this.data.data.DWTP=="4"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/D.png");
        	}else if(this.data.data.DWTP==5||this.data.data.DWTP=="5"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/1.png");
        	}else if(this.data.data.DWTP==6||this.data.data.DWTP=="6"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/2.png");
        	}else if(this.data.data.DWTP==9||this.data.data.DWTP=="9"){
        		img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/hbss/3.png");
        	}
        }else if(this.data.data.IMG_FLAG=='zxzwy'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='dwjzz'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/szsw/sw.png");
        }else if(this.data.data.IMG_FLAG=='YJYC'){
        	img = new SuperMap.Feature.ShapeParameters.Image(dvb[0], dvb[3]+68, "./images/yjyc.gif");
        }
        this.shapes.push(this.shapeFactory.createShape(img));
