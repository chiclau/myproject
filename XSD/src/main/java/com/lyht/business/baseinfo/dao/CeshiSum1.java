...
@Entity
@Table(name="ceshi_sum1")
public class CeshiSum1 implements Serializable{
    ...
    @Column(name = "sd_sheng_id") private Integer sdShengId;

    @Column(name = "sd_shi_id") private Integer sdShiId;

    @Column(name = "sd_xian_id") private Integer sdXianId;
