...
public class FsdrFormBean implements Serializable{
	...
	public Fsdr getmFsdrInfoBean() {
		return mFsdrInfoBean;
	}
	public void setmFsdrInfoBean(Fsdr mFsdrInfoBean) {
		this.mFsdrInfoBean = mFsdrInfoBean;
	}
