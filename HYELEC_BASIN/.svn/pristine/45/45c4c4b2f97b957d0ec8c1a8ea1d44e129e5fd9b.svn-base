...
public class RegisterAction extends BaseLyhtAction {
	...
	public String getRegisterInfo(){
		...
		boolean sysUserInfo=mSysUserService.insertSysUserInfo(mSysUserFormBean.getmSysUserInfoBean(),userCode,staffCode);
		boolean sysStaffInfo=mSysStaffService.insertSysStaffInfo(mSysStaffFormBean.getmSysStaffInfoBean(),staffCode); 
