...
<form id="query_form" name="info_form" class="form-inline"
	...
	<div class="modal fade" id="query_info_diurnalEvaporation">
					...
					<table class="table table-bordered" style="margin-bottom: 0px;">
						<tr>
							...
							<td style="width: 300px; text-align: left"><lable
								style="margin-left: 15px;" id="STCD_detail">BM20180100</lable></td>
							<td
								style="width: 100px; text-align: right; font-weight: bold; background: #f1f1f1">
								<lable>时间：</lable>
							</td>
							<td style="width: 300px; text-align: left"><lable
								style="margin-left: 15px;" id="TM_detail">2018-11-12 12:12:23</lable></td>
						</tr>
						<tr>
							<td
								style="width: 100px; text-align: right; font-weight: bold; background: #f1f1f1">
							...
							<td style="width: 300px; text-align: left"><lable
								style="margin-left: 15px;" id="EPTP_detail">循环式</lable></td>
							<td
								style="width: 100px; text-align: right; font-weight: bold; background: #f1f1f1">
								<lable>日蒸发量：</lable>
							</td>
							<td style="text-align: left"><lable
								style="margin-left: 15px;" id="DYE_detail">12mm</lable></td>
						</tr>
					</table>
				</div>
