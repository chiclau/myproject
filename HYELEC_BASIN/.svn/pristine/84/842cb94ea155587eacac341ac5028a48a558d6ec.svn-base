...
public class RsvrFormBean implements Serializable{
	...
	public Rsvr getmRsvrInfoBean() {
		return mRsvrInfoBean;
	}
	public void setmRsvrInfoBean(Rsvr mRsvrInfoBean) {
		this.mRsvrInfoBean = mRsvrInfoBean;
	}
