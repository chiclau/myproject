			...
			if(userName != "" && stcd !=""){
				...
				common_ajax(null,url, function(response) {
					...
					for(var i =0;i<response.rows.length;i++){
						...
						index.push(i);
						var tr = "<tr>"+
						"<td style='text-align: left'><input style='margin-left: 15px;width: 90px' class='a' id='pa_rrff_x' value="+response.rows[i].Pa+" name='pa'></td>"+
						"<td style='text-align: left'><input style='margin-left: 15px;width: 90px' class='a' id='p_rrff_x' value="+response.rows[i].P+" name='p'></td>"+
						"<td style='text-align: left'><input style='margin-left: 15px;width: 90px' class='a' id='r_rrff_x' value="+response.rows[i].R+" name='r'></td>"+
						"<td style='text-align: left'>" +
