...
<div class="row-fluid col-md-12">
	<div id="tbar" class="btn-toolbar">
		<div class="btn-group">
			<button type="button" id="query_add_riverWater" class="btn btn-primary">
		...
		<div class="btn-group">
			<button type="button" id="btn_del_riverWater" class="btn btn-danger btn_del_color">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<button class="btn btn-primary" id="btn_into_pptn_river" type="button">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<button class="btn btn-primary" id="btn_outAll_pptn_river" type="button">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<button class="btn btn-primary" id="btn_outPage_pptn_river" type="button">
		...
		<div class="btn-group pull-right col-lg-2 col-md-2 col-sm-2 col-xs-4" >
			<div class="input-group" style="float: left;right: 190px">
				<select id="stcd_river_list" class="form-control" style="width: 180px" 
			...
			<div class="input-group" style="float: left;margin-top: -32px;left: 0px">
				<input type="text" id="query_searchName_river" name="searchName" autofocus="autofocus" class="form-control" placeholder="输入关键字进行模糊查询">
				<span class="input-group-btn">
					<button class="btn btn-primary" id="query_ref_river" type="button">
...
<!-- 按钮工具条结束 -->
<table id="query_table_riverWater"  class="table-condensed table-hover table-cursor">
    <thead>
        <tr>
			...
			<th data-halign="center" data-align="right" data-sortable="false" data-field="Z" data-width="" data-formatter="">水位(m)</th>
			<th data-halign="center" data-align="right" data-sortable="false" data-field="Q" data-width="" data-formatter="">流量(m<sup>3</sup>/s)</th>
			<th data-halign="center" data-align="center" data-sortable="false" data-field="FLWCHRCD" data-width="" data-formatter="FMT_FLWCHRCD">河水特征码</th>
			<th data-halign="center" data-align="right" data-sortable="false" data-field="WPTN" data-width="" data-formatter="FMT_WPTN">水势</th>
