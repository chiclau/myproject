(function($) {
	$("#ssdwf").hide();
	var myCharts = echarts.init(document.getElementById("ssdwf_main"));
	var symbolSize = 3;
	var points = [];
	    ...
	    series: [
	        {
	            ...
	            data:[234, 461, 456, 745, 345, 633,34,534]
	        },
	        {
	            id: 'b',
	            type: 'line',
	            smooth: true,
	            symbolSize: symbolSize,
	            data:[123, 435, 657, 879, 234, 234,456,456]
	        }
	    ]
	};
	myCharts.setOption(option);
	
	$("#btn_table_ssdwf").click(function(){
	   $("#ssdwf_main").hide();
	   $("#ssdwf_tlgcxf").show();
	   $("#ssdwf").show();
	   table();
	})
	$("#btn_chart_ssdwf").click(function(){
	   $("#ssdwf_main").show();
	   $("#tbinfo_ssdwf").hide();
	   $("#ssdwf").hide();
	   $("#tbinfo_ssdwf").empty();
