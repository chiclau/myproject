			...
			<div id="wdrs_div" class="col-md-8" style="height:100%;">
				<div style="height:32px;float: right;">
						...
						<input id="TAB_PCH" type="text"  class="form-control"
							style="width: 100;display:inline;" value="20180501">
						<label>流域面积(km²):</label>
						<input id="TAB_LYMJ" type="text" class="form-control"
							style="width: 100;display:inline;" value="200">
...
$(function(){
	...
	$("#stcd").val(stcd);
	$("#start").val(beginDate);
	getwdrsTable("#wdrs_div","#wdrs_tab",basePath + "chanliu/chanliu!step6.action",{"stcd":stcd,"start":beginDate, "end":endDate});
