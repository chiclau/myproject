...
function reckon(){
	...
	var tr=$(".removeTr");
	 ...
	 var DATA1=tojson(DATA);
	 var da=DATA.slice(0,2); //先截取前2段数据
	 var j=tojson(da);	//转JSON
	 alert(code)
	...
	// alert(DATA1); 
	 ...
	 var url="http://113.240.224.29:8099/CHLService.asmx?op=getPa&Pa=100&DT=60;DATA={'DATA':[{'TM':'2018-6-11 11:00','DRP':'12','EM':'2'},{'TM':'2018-6-11 12:00','DRP':'14','EM':'2'}]}&COEFDATA= {'COEFDATA':[{'K':'1.2','B':'0.3','C':'0.1','im':'0.02','WM':'130','WUM':'0.2','WLM':'0.8','SM':'60','EX':'1.5','KG':'0.4','KI':'0.3'}]}";
	 common_ajax(null, url, function(response) {//ajax提交。回调函数
		 alert("success")
		}); 
}
