...
<div class="modal fade" id="diurnalEvaporation_info_upload">
		<div class="modal-dialog modal-lg" style="width:680px">
			<div class="modal-content">
				...
				<div class="modal-header" style="height: 40px">
					...
					<h4 class="modal-title"><i class="icon icon-cloud-download"></i>&nbsp;需求计划导入</h4>
				</div>
				
				<div class="modal-body">
					<div id='diurnalEvaporation_myUploader' class="uploader">
