		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
					...
					<div class="row">
						&nbsp;站类选择 : <label class="checkbox-inline"> <input
							type="checkbox" name='message' value="RR"> 水库
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name='message' value="ZS"> 河道
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name='message' value="DD"> 堰闸
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name='message' value="TT"> 潮汐
						</label>
					</div>
					<div class="row">
						<!--                    &nbsp;水库类型 :
							...
							<div class="col-md-12" class="margin-top:-20px"
								...
								<form class="form-inline">
									...
									<button type="button" class="btn btn-default btn btn-success"
										style="color: white" onclick="loadData()">查询</button>
								</form>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-12"
							style="overflow: auto; height: 157px; width: 290px;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">实时水情统计</h4>
      </div>
