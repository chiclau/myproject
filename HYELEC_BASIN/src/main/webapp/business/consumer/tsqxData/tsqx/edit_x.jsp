			...
			<div class="modal-content">
				...
				<div class="form-group" style="margin-top: 10px;">
					...
					<div class="col-md-2 rowGroup">
						<input type="text" class="form-control" id="stnm_tsqx_x" 
					...
					<div class="col-md-2 rowGroup">
                            <input type="text" class="form-control" id="userName_tsqx_x" 
				...
				<div id="myEcharts_tsqx" style="position:absolute; top:50px; left:430px;width: 560px; height:500px;">
				</div>
