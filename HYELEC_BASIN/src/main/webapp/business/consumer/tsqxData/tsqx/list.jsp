					...
					<div id="tbar" class="btn-toolbar">
						...
						<div class="btn-group pull-right col-lg-4 col-md-4 col-sm-4 col-xs-6">
							<div class="input-group">
								<input type="text" id="query_searchName_tsqx" autofocus="autofocus" class="form-control" placeholder="输入关键字进行模糊查询"> 
...
<script src="<%=basePath %>business/consumer/tsqxData/tsqx/query.js"></script>
<script src="<%=basePath %>business/consumer/tsqxData/tsqx/list.js"></script>
