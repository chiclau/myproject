	...
	<div id="tbar" class="btn-toolbar">
		...
		<div class="btn-group pull-right col-lg-4 col-md-4 col-sm-4 col-xs-6">
			<div class="input-group">
				<input type="text" id="query_searchName_zqrl" autofocus="autofocus" class="form-control" placeholder="输入关键字进行模糊查询"> 
...
<!-- 按钮工具条结束 -->
<table id="query_table_waterLevelFlow"  class="table-condensed table-hover table-cursor">
    <thead>
        <tr>
			...
			<th data-halign="center" data-align="center" data-sortable="false" data-field="LNNM" data-width="">曲线名称</th>
			<th data-halign="center" data-align="center" data-sortable="false" data-field="PTNO" data-width="" data-formatter="">曲线序号</th>
			<th data-halign="center" data-align="right" data-sortable="false" data-field="Z" data-width="" data-formatter="">水位</th>
