...
<div class="row-fluid col-md-12" style="height:35px;">
	<div id="tbar" class="btn-toolbar">
		<div class="btn-group">
			<button type="button" id="query_add_dayprecipitation" class="btn btn-primary">
		...
		<div class="btn-group">
			<button type="button" id="btn_del_dayprecipitation" class="btn btn-danger btn_del_color">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<button class="btn btn-primary" id="btn_into_daypre" type="button">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<button class="btn btn-primary" id="btn_muban_day_pptn" type="button">
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<a class='date' style="left:10px;"> <label
				class="input" style="display: inline;width:180px;"> <input
					...
					id="startTime_daypptn" name="startTime" required data-bv-group=".rowGroup"
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<a class='date' style="left:10px;"> <label
				class="input" style="display: inline;width:180px;"> <input
					type='text' class="laydatetime" autofocus="autofocus"
					style="width: 170px; height: 30px;background-color:#fff;" readonly="readonly"
					id="endTime_daypptn" name="endTime" required data-bv-group=".rowGroup"
					data-bv-notempty-message="时间不能为空"
		...
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<select id="stcd_daypptn_list" class="form-control" style="width: 150px;margin-left:10px;" 
                      	data-bv-group=".rowGroup" 
                      	required data-bv-notempty-message="请选择测站名称">
			</select>
		</div>
		<div class="btn-group pull-left visible-lg visible-md visible-sm">
			<input type="text" id="query_searchName_daypptn" style="width:150px;float:left;" name="searchName" autofocus="autofocus" class="form-control" placeholder="输入关键字进行模糊查询">
			<button class="btn btn-primary" style="width:80px;float:right;" id="query_ref_daypred" type="button">
...
<!-- 按钮工具条结束 -->
<div id="query_table_dayprecipitation_div" style="width:100%;height:calc(100% - 40px);overflow:auto;">
	<table id="query_table_dayprecipitation"  class="table-condensed table-hover table-cursor">
	    <thead>
	        <tr>
				...
				<th data-halign="center" data-align="center" data-sortable="false" data-field="NM" data-width="140px" data-formatter="FMT_handle6">操作</th>
	        </tr>
	    </thead>
	</table>
</div>
