...
cityareacode[0]=new Array('0101','0102','0103','0104','0105','0106','0107','0108','0109','0110','0111','0112','0113','0114','0115','0116','0117','0118');
cityareaname[0]=new Array('东城区','西城区','崇文区','宣武区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','平谷区','怀柔区','密云县','延庆县');
if (selectP=='02')
...
cityareaname[2]=new Array('宝山区','金山区','南市区','长宁区','静安区','青浦区','崇明区','卢湾区','松江区','奉贤区','浦东区','杨浦区','虹口区','普陀区','闸北区','黄浦区','闵行区','徐汇区','嘉定区','南汇区');
if (selectP=='04')
...
cityareacode[3]=new Array('0401','0402','0403','0404','0405','0406',
		'0407','0408','0409','0410','0411','0412','0413','0414','0415','0416','0417','0418',
		'0419','0420','0421','0422','0423','0424','0425','0426','0427','0428','0429','0430',
		'0431','0432','0433','0434','0435','0436','0437','0438','0439','0440','0441');
cityareaname[3]=new Array('渝中区','大渡口区','江北区','南岸区','北碚区','渝北区'
		   ,'巴南区','长寿区','双桥区','沙坪坝区','万盛区','万州区'
		   ,'涪陵区','黔江区','永川区','合川区','江津区','九龙坡区','南川区','綦江县','潼南县','荣昌县'
		   ,'璧山县','大足县','铜梁县','梁平县','开县','忠县','城口县','垫江县','武隆县','丰都县'
		   ,'奉节县','云阳县','巫溪县','巫山县','石柱土家族自治县','秀山土家族苗族自治县'
...
cityareacode[4]=new Array('0501','0502','0503','0504','0505','0506','0507','0508','0509','0510','0511','0512','0513','0514','0515','0516','0517','0518','0519');
cityareaname[4]=new Array('和平区','河北区','河西区','河东区','南开区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区','津南区','北辰区','武清区','滨海区','宝坻区','宁河县','静海县','蓟 县');
if (selectP=='06')
...
cityareaname[5]=new Array('广州市','珠海','中山市','佛山','东莞市','清远','肇庆','阳江','湛江','韶关','惠州','河源','汕尾','汕头','梅州','潮州市');
if (selectP=='07')
...
cityareacode[8]=new Array('0901','0902','0903','0904','0905','0906','0907','0908','0909','0910');
cityareaname[8]=new Array('呼和浩特','包头','乌海','临河','东胜','集宁','锡林浩特','通辽','赤峰','乌兰浩特');
if (selectP=='10')
...
cityareaname[24]=new Array('贵阳','六盘水','遵义','铜仁','毕节','安顺','黔西南布依族苗族自治州','黔东南苗族侗族自治州','黔南布依族苗族自治州');
if (selectP=='26')
...
cityareaname[26]=new Array('拉萨','那曲','昌都','山南','日喀则地区','阿里','林芝');
if (selectP=='28')
