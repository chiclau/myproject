...
public class Result  implements Serializable{
	...
	public Integer getYml() {
		return yml;
	}

	public void setYml(Integer yml) {
		this.yml = yml;
	}
	...
	public String toString() {
		return "Result [yml=" + yml + ", createTime=" + createTime + ", ymlTime=" + ymlTime + ", createStaff="
				+ createStaff + ", pch=" + pch + ", stcd=" + stcd + ", jyl=" + jyl + ", id=" + id + ", stnm=" + stnm
				+ ", qz=" + qz + "]";
	}
	...
	public Result( Integer yml,String createTime,String ymlTime,String pch,String stcd,String createStaff, String jyl,String id,
