...
public class RiverFormBean implements Serializable{
	...
	private River mRiverInfoBean=new River();
	...
	public River getmRiverInfoBean() {
		return mRiverInfoBean;
	}
	public void setmRiverInfoBean(River mRiverInfoBean) {
		this.mRiverInfoBean = mRiverInfoBean;
	}
